...
type AddInsulinScreenNavigationProp = NativeStackNavigationProp<RootStackParamList, 'AddInsulin'>;

interface Props {
  navigation: AddInsulinScreenNavigationProp;
}

export default function AddInsulinScreen({ navigation }: Props) {
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView style={styles.scrollView}>
        <View style={styles.content}>
          ...
          <Text style={styles.label}>İnsülin Tipi</Text>
          <TextInput
            style={styles.input}
            value={insulinType}
            onChangeText={setInsulinType}
            placeholder="Örn: Hızlı Etkili, Uzun Etkili"
          />
